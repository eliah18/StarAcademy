         ...
         <!-- <h1 class="h3 mb-2 text-gray-800">Accepted Students List</h1>-->
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">My Database</h6>
            </div>
            <div class="card-body">
             <!-- start code -->
...
<form method='post' action='backup.php?action=save'>
	
    <div class="alert alert-info"><center>Please backup your database on a daily basis</center></div>
    <p><center><?php $Today = date('y:m:d');
                        $new = date('l, F d, Y', strtotime($Today));
                        echo $new;
	 ?></center></p>
     <p><center style="color:#F00;">SQL Database backup</center></p>
     <br><br>
     
     <center><button type="submit" name="submit" class="btn btn-success btn-lg"><i class="fas fa-spinner"></i>&nbsp Backup</button></center>
