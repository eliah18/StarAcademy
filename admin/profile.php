...
if(isset($_SESSION['access']) && $_SESSION['fullname']  && $_SESSION['access']=="Admin") {
  if(isset($_POST['btnSubmit'])){
    ...
    $phone =$_POST["phone"];
     if($pass !== $pass2 ){
      echo ("<SCRIPT LANGUAGE='JavaScript'> window.alert('Your password does not match confirm password')
     javascript:history.go(-1)
      </SCRIPT>");  
     }
     else if( $pass2 == '' OR $pass == ''){
      echo ("<SCRIPT LANGUAGE='JavaScript'> window.alert('Your password cannot be empty')
     javascript:history.go(-1)
      </SCRIPT>");  
     }
     else{
       $sql = "UPDATE `users` SET `cell_num`='$phone',`password`='$pass'  WHERE `username`='$username'";
       if($connection-> query($sql)) { 
          echo ("<SCRIPT LANGUAGE='JavaScript'> window.alert('Profile updated successfully')
        javascript:history.go(-1)
         </SCRIPT>");  }
    }}
     ?>
...
<?php $sql = "SELECT * FROM users WHERE username = '$_SESSION[username]' ";
                        ...
                        <div class="col-12">
                            <form method="post" action="" >
                                <div class="form-group">
                                    <label for="name">Account Fullname</label>
                                    <input value="<?php echo  $full ;?>" id="fullname"   type="text" class="form-control " readonly>
                                </div>
                                <div class="form-group">
                                    <label for="name">Account Username</label>
                                    <input  id="username" name="username" value="<?php echo  $_SESSION['username']; ?>" type="text" class="form-control " readonly>
                                </div>
                                <div class="form-group">
                                    <label for="email">Account Email</label>
                                    <input  id="email" value="<?php echo $email ;?>" name="email" type="email" class="form-control "readonly>
                                </div>
                                <div class="form-group">
                                    <label for="phone">Phone</label>
                                    <input  id="phone" name="phone"  value="<?php echo $cell ;?>" type="tel" class="form-control ">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-12 col-sm-4">
                                        <button type="submit" name="btnSubmit" class="btn btn-primary">Update
                                        </button>
                                    </div>
        ...
        <?php } ?>
            ...
            <div class="tm-col tm-col-big">
                <div class="bg-white tm-block">
                    ...
                    <img class="img-profile rounded-circle" src="img/profile-image.png"  alt="Profile Image" >
